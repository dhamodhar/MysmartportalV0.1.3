										...
										?>
                                         ...
                                         <ul <?php if($this->uri->segment(2) == url_title('assets_under_contracts', TRUE) or $this->uri->segment(2) == url_title('assets', TRUE) or $this->uri->segment(2) == url_title('assetsendoflife', TRUE) or $this->uri->segment(2) == url_title('assets_no_contracts', TRUE) or $this->uri->segment(2) == url_title('assets_under_warranty', TRUE) or $this->uri->segment(2) == url_title('assetsendofserviceassets', TRUE)){?> style="display:block;" <?php } ?>>
													 ...
													 <li> <a href="<?php echo $url2;?>" <?php if($this->uri->segment(2) == url_title('assetsendoflife', TRUE)){?> class="orders-active"  <?php } ?>><i class="fa fa-caret-right"></i> End of Life Assets</a></li>
													 													 <li> <a href="<?php echo $assets_under_service;?>" <?php if($this->uri->segment(2) == url_title('assetsendofserviceassets', TRUE)){?> class="orders-active"  <?php } ?>><i class="fa fa-caret-right"></i> End of Service Assets</a></li>
