...
<span class="input-group-addon">
                                        ...
                                        <!-- /col -->
                                        <div class="col-md-2">   <button class="btn btn-blue" onclick="searchbydates()"><i class="fa fa-search"></i></button>
										<button class="btn btn-blue" id="backLink">Back</button>
										</div>
...
View Assets in Map</a> 
   ...
   <div class="row">
                                        ...
                                        <div class="col-md-4" style="display:none"><div id="colVis"></div></div>
