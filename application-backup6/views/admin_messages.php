...
<div class="btn-group"><a href="<?php echo base_url();?>index.php/welcome/admin_composemessage" class="btn btn-default btn-sm br-2" ><font color="red">Compose</font></a></div>
                                </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="media-heading m-0">
                                                    <a href="<?php echo base_url();?>index.php/welcome/view_admin_message/<?php echo $user_notifications_data->id;?>" class="mr-5"><?php echo $user_notifications_data->msg_subject;?></a>
