                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>index.php/welcome/help"></i>Help</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php/welcome/browse_documentation" class="sub-active"></i>Documentation</a>
                                </li>
                            </ul>
...
<button data-control class="btn btn-primary width-100 text-left">Dashboard & Analytics</button>        
...
<article data-accordion>
 ...
 <button data-control class="btn btn-primary width-100 text-left">Orders & Invoices</button>        
...
<div class=" float-right" data-target="#demo1" data-toggle="collapse" aria-expanded="true"></div>
...
<div class="line-hieght-22">You can search by Order Number/Invoice Number/Customer PO/Order Date<br> <br><span class="red">Note:</span> You may search orders &amp; invoices using dates up to 1 year, if you want to get data for more than 1 year, please contact Lowry </div>
 ...
 <div id="demo1" class="level3" aria-expanded="true" style="">
                     <ul>
<li><strong>Orders &amp; Invoices</strong></li>
...
<article data-accordion>
<button data-control class="btn btn-primary width-100 text-left">Services Contracts</button>        
<div data-content>  
...
<div class="line-hieght-22">You may search by Serial Number, Contract Number and Contract Date<br> <br><span class="red">Note:</span> You may search Service Contracts using dates up to 1 year, if you want to get data for more than 1 year, please contact Lowry </div>
 ...
 <div id="demo1" class="level3 accordian-body collapse in" aria-expanded="true" style="">
                     <ul>
<li><strong>Upcoming For Renewal Contracts</strong></li>
<li>Please navigate to Lowry Smart Portal link and login with Your user credentials.</li>
<li>Once logged in, on the left hand side menu User can find service contracts tab as the fifth option.</li>
<li>Click on 'Service Contracts' to expand.</li>
<li>Click on the third option 'Upcoming for Renewal' to display the page</li>
<li><img src="http://lowrysmartportal.com/assets/images/upcoming-img-info.jpg"></li>
<li>The list of all Upcoming for renewal contracts will be displayed in a table.</li>
<li class="blue-bold">Functionality</li>
<li>User can perform various functionalities provided in the expired contracts page for ease of use and access. They are, </li>
<li class="blue-bold"> Upcoming For Renewal Search</li>

<li>User can search the contracts Upcoming For Renewal by using this functionality
User can use any option to search the contracts
<ul class="sub-he">
<li>Serial Number</li>
<li>Contract Number</li>
<li>Contract End Date</li>
...
<article data-accordion>
<button data-control class="btn btn-primary width-100 text-left">Asset Inventory</button>        
<div data-content>  
...
<li>Click on 'Under Contract' to open the corresponding page</li>
<li><img src="http://lowrysmartportal.com/assets/images/UnderContract-img.jpg"></li>
<li>The list of all Under contracts will be displayed in a table.</li>
<li class="blue-bold">Functionality</li>
<li>User can perform various functionalities provided in the expired contracts page for ease of use and access. They are, </li>
<li class="blue-bold">Under Contract Search</li>
<li>User can search Under Contract records by using the functionality</li>
...
<li>Click on 'Asset Inventory' to expand</li>
<li>Click on 'Under Warranty' to open the corresponding page</li>
<li><img src="http://lowrysmartportal.com/assets/images/warrenty-img.jpg"></li>
<li>The list of all Under Warranty contracts will be displayed in a table.</li>
<li class="blue-bold">Functionality</li>
<li>Users can perform various functionalities provided in the Under Contract page for ease of use and access,  They are  </li>


<li class="blue-bold">Under Warranty Search</li>
<li>User can search Under Warranty contracts by using this functionality. </li>
...
<article data-accordion>
<button data-control class="btn btn-primary width-100 text-left ">Profile </button>          
<div data-content>
<div class="col-md-12">
 <div id="demo1" class="level3 ">
                     <ul>
