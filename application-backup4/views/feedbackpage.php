...
<form name="profile" action="<?php echo base_url();?>index.php/welcome/savefeedback" method="post">
                    <!-- page content -->
                    <div class="pagecontent mt-20">
                        ...
                        <!-- row -->
                                           <div class="col-md-6">			  <div class="form-group">
											...
											<div >
                                                <input type="text" class="form-control" name="username_req" id="username_req" value="<?php echo $this->session->userdata('email')?>">
                                            </div>
                                        </div></div>
			                   ...
			                   <div class="col-md-6">							
                                           <div class="form-group">
                                           <label for="input01"  control-label"> Name </label>                                      											
											  <div>
                                                <input type="text" class="form-control" name="first_name_req" id="first_name_req" value="<?php echo $this->session->userdata('firstname')?>">
                                            </div>
                                        </div>			  
                                        </div>
...
<div class="col-md-6">				  <div class="form-group">
                                            <label for="input01"  control-label">Company Name </label>
											 ...
											 <div>
                                                <input type="text" class="form-control" name="bus_name_req" id="bus_name_req" value="<?php echo $this->session->userdata('cust_code')?>">
                                            </div>
                                        </div></div>
				            ...
				            <div class="col-md-6">				
                                            ...
                                            <label for="input01"  control-label">Phone Number </label>
											 ...
											 <div>
                                                <input type="text" class="form-control" name="phone1_req" id="phone1_req" value="<?php echo $this->session->userdata('phone_number')?>">
                                            </div>
                                        </div></div>
