		...
		if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
					...
					$data['ids']=$usermenu[0]->menu_id;
						 if($orderpageaccess=="ok")
						 {
							 ...
							 $this->load->view('service_desk_tickets');
							 $this->load->view('service_desk_tickets_footer');
				         }else
						 {
						     redirect(base_url()."index.php/welcome/technical_support");
...
<footer style="background-color: #51445f;width:100%;height:40px;position:absolute;bottom:0px;color:#fff;text-align:right;font-size:12px;line-height:40px;">Copyright © 2016 lowrysmartportal.com. All rights reserved. </footer>
	...
	/**
	 *  All Past Invoices Data Fetching from API. 
	 *  @API(E21GetInvoiceList)
	 *  @Parama
	 *  Page Limit (25)
	 */  
	public function all_past_invoices($count=25)
	{
			...
			$cust_code= $this->session->userdata('cust_code'); 
			$email1=$this->session->userdata('email');
			$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/E21PastDueInvoices/'.$cust_code.'/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
								  );
	...
	if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
						...
						$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/E21ActiveServiceContracts/'.$cust_code.'/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'));
						
						}else if($userstatus=="Expired")
						{
						$ServiceContractList_node = "AssetsUnderContract";
							$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/E21GetExpiredContracts/'.$cust_code.'/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
											  );
						
						}else if($userstatus=="Cancelled")
						{
						$ServiceContractList_node = "ServiceContractList";
							$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/ServiceContractDueToRenew/'.$cust_code.'/50/1/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
											  );
						...
						$ServiceContractList_node = "GetAllActiveContract";
							$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/E21GetAllExpiredContracts/'.$cust_code.'/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
											  );
    ...
    public function all_assets_under_contracts_api($Contract_Number=null,$count1=1)
	  {
			...
			if($Contract_Number==null)
				...
				$Contract_Number = " ";
					...
					$cust_code= $this->session->userdata('cust_code'); 
					$email1=$this->session->userdata('email');
					$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/E21GetAssetsUnderContract/'.$cust_code.'/'.$count1.'/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
										  );
								  ...
								  foreach ($urlArray as $url) 
								  {
											   ...
											   {
													echo "<assetspage diffgr:id='AssetsPage1' msdata:rowOrder='0' diffgr:hasChanges='inserted'><SerialNumber>".$node->getElementsByTagName('Serial')->item(0)->nodeValue."</SerialNumber><Part_Number>".$node->getElementsByTagName('Product')->item(0)->nodeValue."</Part_Number><Part_Description>".$node->getElementsByTagName('ProductDesc')->item(0)->nodeValue."</Part_Description><Type> </Type><contract_number>".$node->getElementsByTagName('Contract')->item(0)->nodeValue."</contract_number><Start_Date></Start_Date><End_date>".$node->getElementsByTagName('ContrTo')->item(0)->nodeValue."</End_date><Contract_Status></Contract_Status><Options></Options><assetaddress>".$node->getElementsByTagName('Address')->item(0)->nodeValue."</assetaddress><Error>".$node->getElementsByTagName('Error')->item(0)->nodeValue."</Error></assetspage>";
											   }                      					    
												  echo "</DocumentElement></diffgr:diffgram></DataTable>";
 ...
 public function all_assets_end_of_life($Contract_Number=null,$count1=25)
	  {
			...
			if($Contract_Number==null)
				...
				$Contract_Number = " ";
					...
					$cust_code= $this->session->userdata('cust_code'); 
					$email1=$this->session->userdata('email');
				    $urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/E21GetAssetsEndOfLife/'.$cust_code.'/1/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
										  );
								  ...
								  foreach ($urlArray as $url) 
								  {
											   ...
											   foreach ($rss->getElementsByTagName('AssetsUnderContract') as $node)
											   {
													echo "<assetspage diffgr:id='AssetsPage1' msdata:rowOrder='0' diffgr:hasChanges='inserted'><SerialNumber>".$node->getElementsByTagName('Serial')->item(0)->nodeValue."</SerialNumber><Part_Number>".$node->getElementsByTagName('Product')->item(0)->nodeValue."</Part_Number><Part_Description>".$node->getElementsByTagName('ProductDesc')->item(0)->nodeValue."</Part_Description><Type> </Type><contract_number>".$node->getElementsByTagName('Contract')->item(0)->nodeValue."</contract_number><Start_Date>".$node->getElementsByTagName('ContrTo')->item(0)->nodeValue."</Start_Date><End_date>".$node->getElementsByTagName('EndofLifeDate')->item(0)->nodeValue."</End_date><Contract_Status></Contract_Status><Options></Options><assetaddress>".$node->getElementsByTagName('Address')->item(0)->nodeValue."</assetaddress><Error>".$node->getElementsByTagName('Error')->item(0)->nodeValue."</Error></assetspage>";
											   }                      					    
												  echo "</DocumentElement></diffgr:diffgram></DataTable>";
...
public function active_service_contracts()
 ...
 public function expired_service_contracts()
  ...
  public function composemessage($msg = null)
  {
   if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
  ...
  public function admin_composemessage($msg = null,$id=null)
  {
   if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
               ...
               if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				...
				}else
				{
					...
					$notifications = $this->Mysmartportal_model->savenotifications($notification_param);
																	 ...
																	 redirect(base_url()."index.php/welcome/composemessage/suc");
