			...
			if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
					...
					$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/E21GetOrders/'.$cust_code.'/'.$email1.'/UserType/PermLevel/50/1/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213/order_date/asc'),
										  );
					...
					$ids= $ids.",".$value;
						 ...
						 $paramsid = $ids;
								 ...
								 //sending email code  start
										 $to = "bhaskar@livait.com,nikd@lowrysolutions.com,rami@lowrysolutions.com";
	...
	function upload_attendance()
	{
				...
				for($j=2; $j <= sizeof($sheetData); $j++) 
		          {
						 ...
						 /*echo $check;
						 echo "H".$sheetData[$j]['H']."<br>";
						 echo "A".$sheetData[$j]['A']."<br>";
						 echo "C".$sheetData[$j]['C']."<br>";
						 echo "D".$sheetData[$j]['D']."<br>";
						 echo "E".$sheetData[$j]['E']."<br>";
						 echo "F".$sheetData[$j]['F']."<br>";
				         echo "G".$sheetData[$j]['G']."<br>";
						 echo "H".$sheetData[$j]['H']."<br>";
						 echo "I".$sheetData[$j]['I']."<br>";
						 echo "J".$sheetData[$j]['J']."<br>";
						 echo "K".$sheetData[$j]['K']."<br>";
						 echo "L".$sheetData[$j]['L']."<br>";
						 echo "M".$sheetData[$j]['M']."<br>";
				         echo "N".$sheetData[$j]['N']."<br>";
						 echo "O".$sheetData[$j]['O']."<br>";
						 echo "P".$sheetData[$j]['P']."<br>";
						 echo "Q".$sheetData[$j]['Q']."<br>";
						 echo "R".$sheetData[$j]['R']."<br>";
						 echo "S".$sheetData[$j]['S']."<br>";						 
						 exit;
						 */
						  ...
						  if(($check>0) or ($sheetData[$j]['F']==1) ){
							 ...
							 if(($sheetData[$j]['A']=="") or ($sheetData[$j]['C']=="") or ($sheetData[$j]['D']=="") or ($sheetData[$j]['E']=="") or ($sheetData[$j]['F']=="") or ($sheetData[$j]['G']=="") or ($sheetData[$j]['H']=="") or ($sheetData[$j]['I']=="") or ($sheetData[$j]['J']=="") or ($sheetData[$j]['K']=="") or ($sheetData[$j]['L']=="") or ($sheetData[$j]['M']=="") or ($sheetData[$j]['N']=="") or ($sheetData[$j]['O']=="") or ($sheetData[$j]['P']=="") or ($sheetData[$j]['Q']==""))
							 {
							  redirect(base_url()."index.php/welcome/allusers/error");
		...
		for($x=2; $x <= sizeof($sheetData); $x++) 
		{
											 ...
											 // $username=$sheetData[$x]['E'];
											  ...
											  $menu8 = $sheetData[$x]['N'];
											  $menu9 = $sheetData[$x]['O'];
											  $menu10 = $sheetData[$x]['P'];
											  $menu11 = $sheetData[$x]['Q'];
											   ...
											   if($check>0)
											   {
											     ...
											     redirect(base_url()."index.php/welcome/allusers/inserted1/duplicated_".$errormail);
														...
														if($menu6 != "" or $menu6!=0)
														 ...
														 //sending email code  start
										 $to = "dhamu.enaganti@gmail.com,uzwal.chaganti@livait.com";
										 $subject = "LowrySmart Portal - New Account Registration";
...
<footer style="background-color: #51445f;width:100%;height:40px;position:absolute;bottom:0px;color:#fff;text-align:right;font-size:12px;line-height:40px;">Copyright © 2016 lowrysmartportal.com. All rights reserved. </footer>
	...
	public function invoice_search($from,$to,$invoice_number)
	{
			...
			$cust_code= $this->session->userdata('cust_code'); 
			$email1=$this->session->userdata('email');
			$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/E21GetInvoiceList_Search/'.$cust_code.'/'.$email1.'/'.$from.'/'.$to.'/'.$invoice_number.'/UserType/PermLevel/50/1/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213/invoice_numb/desc'),
								  );
  ...
  public function pdf($order_id = null,$email = null)
  {
	...
	$data['usemail'] = str_replace('ZZZ', '@', $email);
	            $cust_code= $this->session->userdata('cust_code'); 
				 $email1= $this->session->userdata('email'); 
				$rss = new DOMDocument(); 
				//echo "http://216.234.105.194:8088/Alpha.svc/E21GetOrderInvoiceHeader/".$cust_code."/".$order_id."/"."%20/".$email1."/UserType/PermLevel/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213";
				$rss->load("http://216.234.105.194:8088/Alpha.svc/E21GetOrderInvoiceHeader/".$cust_code."/".$order_id."/ /".$email1."/UserType/PermLevel/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213");
					//echo print_r($rss);
									   foreach ($rss->getElementsByTagName('InvoiceHeader') as $node)
										   ...
										   //echo $node->getElementsByTagName('invoice_numb')->item(0)->nodeValue;
  ...
  public function all_servicecontracts($userstatus = null)
  {
	if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
...
echo $salesdata;
   ...
   public function all_assets_to_csv()
  {
    ...
    public function all_assets($Contract_Number=null)
  {
	if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
			...
			$cust_code= $this->session->userdata('cust_code'); 
			$email1=$this->session->userdata('email');
			$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/AssetsPage/'.$cust_code.'/ /'.$Contract_Number.'/125/1/End_date/desc/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
								  );
    ...
    public function all_opentickets_by_email($userstatus = null)
  {
	if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
			...
			$cust_code= $this->session->userdata('cust_code'); 
			$email1=$this->session->userdata('email');
			$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/CheckServiceTicket_Email/arolson@arcticcat.com/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
								  );
						  ...
						  foreach ($urlArray as $url) 
						  {
									   ...
									   foreach ($rss->getElementsByTagName('CheckServiceTicket') as $node)
									   {
										...
										echo "<checkserviceticket diffgr:id='contract1' msdata:rowOrder='0' diffgr:hasChanges='inserted'><opened>".$node->getElementsByTagName('Opened')->item(0)->nodeValue."</opened><lastaction>".$node->getElementsByTagName('LastAction')->item(0)->nodeValue."</lastaction><enteredby>".$node->getElementsByTagName('Enteredby')->item(0)->nodeValue."</enteredby><ticketnumber>".$node->getElementsByTagName('TicketNumber')->item(0)->nodeValue."</ticketnumber><problemdescription>".$node->getElementsByTagName('ProblemDescription')->item(0)->nodeValue."</problemdescription><currentstatus>".$node->getElementsByTagName('CurrentStatus')->item(0)->nodeValue."</currentstatus><customername>".$node->getElementsByTagName('CustomerName')->item(0)->nodeValue."</customername><calledinby>".$node->getElementsByTagName('CalledInBy')->item(0)->nodeValue."</calledinby><email>".$node->getElementsByTagName('Email')->item(0)->nodeValue."</email><serviceagent>".$node->getElementsByTagName('ServiceAgent')->item(0)->nodeValue."</serviceagent><do>".$node->getElementsByTagName('DO')->item(0)->nodeValue."</do></checkserviceticket>";
  ...
  public function exportallusers_to_excel()
  {
				   ...
				   $csv_data = "First Name,Last Name,Username/Email,Customer Code,Role (3-power user::2-normal user),Status (1-Active::0-Inactive)";
				   foreach($allusers as $allusersdata)
				   {
						   if($csv_data == "")
						   {
							 $csv_data = $allusersdata->first_name.",".$allusersdata->last_name.",".$allusersdata->email_id.",".$allusersdata->cus_code.",".$allusersdata->role.",".$allusersdata->status;
						  
						   }else{
						      $csv_data = $csv_data."_".$allusersdata->first_name.",".$allusersdata->last_name.",".$allusersdata->email_id.",".$allusersdata->cus_code.",".$allusersdata->role.",".$allusersdata->status;
						   }
				   }
  ...
  public function contracts_to_renew_count()
  {
	if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
						...
						$cust_code= $this->session->userdata('cust_code'); 
						$email1=$this->session->userdata('email');
						$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/ContractsToRenewCount/'.$cust_code.'/6/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
											  );
    ...
    public function all_contracts_to_renew()
  {
	if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
						...
						$cust_code= $this->session->userdata('cust_code'); 
						$email1=$this->session->userdata('email');
						$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/ServiceContractDueToRenew/'.$cust_code.'/5000/1/6/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
											  );
      ...
      public function device_query_info()
  {
	if($this->session->userdata('is_logged_in') == '' && $this->session->userdata('is_logged_in') == 0)
				{
				   redirect(base_url()."index.php/welcome/index");
						...
						$cust_code= $this->session->userdata('cust_code'); 
						$email1=$this->session->userdata('email');
						$urlArray = array(array('name' => 'api', 'url' => 'http://216.234.105.194:8088/Alpha.svc/QueryDeviceInfo/180548122583/5434548B-9C59-451E-9673-1D462C11953B/E2795374-87A2-45DE-AD46-194D042B6213'),
											  );
