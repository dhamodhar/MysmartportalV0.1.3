...
function saveexcel()
{
    ...
    window.open('<?php echo base_url()?>index.php/welcome/all_renewal_servicecontracts_to_csv', '_blank');
}
</script>
    </body>
</html>