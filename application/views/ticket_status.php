...
<div class="page-core-dashboard">
                ...
                <div class="page page-dashboard">
					...
					<div>
					<input type="text" name="ticket_number" id="ticket_number" placeholder="Enter Ticket Number">
					<input type="button" name="search" id="search" value="Search" onclick="get_ticket_status()">
					</div>
