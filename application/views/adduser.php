                                ...
                                <div class="profile-form">
                                    ...
                                    <form action="<?php echo base_url()?>index.php/welcome/saveuser" method="post"  role="form">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div>
                                                <input type="email" class="form-control" name="email" id="email" onchange="getdetails()" required>
                                            </div>
                                        </div>
                                        </div>
						 ...
						 <div class="col-md-6">				  <div class="form-group">
							 ...
							 <div class="col-md-6">			  <div class="form-group">
											...
											<label class="checkbox checkbox-custom-alt col-sm-3">
                                                    <input type="checkbox" class="checkbox1" name="check[]" id="check[]" value="1"><i></i> Technical Support
                                                </label>
											<label class="checkbox checkbox-custom-alt col-sm-3">
