                        ...
                        <div class="add-nav">
                         <div class="nav-heading">
                          ...
                          <ul role="tablist" class="nav nav-tabs">
                                    <li class="active" role="presentation"><a data-toggle="tab" role="tab" aria-controls="details" href="#">Order Details</a></li>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                               <!-- <p class="text-default lt">Created: January 29, 2015 at 16:58</p>-->
																...
																<div id="editor"></div>
																<input type="button" name="er" id="er" value="Generate PDF" onclick="test()">
                                                                <h3 class="text-uppercase text-success mt-0 mb-20"><P id="status_order"></p></h3>
																 <h3>Order : <strong id="order_number"></strong></h3>
                                                            </div>
                                                            <!-- /col -->
                                                            ...
                                                            <div class="col-md-4 b-r" id="order_details">
                                                                ...
                                                                <ul class="list-unstyled text-default lt mb-20">
                                                                   <!-- <li><strong>Order Number : </strong></li>
                                                                    ...
                                                                    <li><strong>Total Order Amount : </strong> </li>
									...
									<div class="col-md-4 b-r" id="billing">
                                                ...
                                                <section class="tile tile-simple">
                                                    ...
                                                    <div class="tile-body p-0">
														...
														<div id="wait1"><img src="<?php echo base_url()?>assets/ajax-loader.gif"></div>
