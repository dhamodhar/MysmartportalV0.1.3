                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar col-md-6 col-xs-12 xs-mb-10">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href=" " class="sub-active">Assets End of Service</a>
                                </li>
...
<div class="col-md-12" style="line-height:25px;background:#d6e8f3;">
                                        <strong>End of Service Life Cycle:</strong>&nbsp;&nbsp; Product is no longer supported by the manufacturer. As a general rule, your Lowry Solutions On-Site Service Contract will remain in effect as long as parts are available by reasonable means. </div>
                                        </div>
                                            <table class="table table-striped table-hover table-custom" id="assets-list">
                                                ...
                                                <tr>
													...
													<th style="width:100px;" class="active">End Of Life Date</th>
