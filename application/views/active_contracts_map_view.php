			  ...
			  // var encodedString = Base64.encode(contract_number);
				//var finalordernumber = encodeURIComponent(String(encodedString));
						...
						for(var i=0;i<data.length;i++)
						{
						  ...
						  var encodedString = Base64.encode(data[i]);
				var finalordernumber = encodeURIComponent(String(encodedString));
						if(links == "")
						{
						links = '<a href="http://lowrysmartportal.com/index.php/welcome/assets/'+finalordernumber+'"  style="text-decoration: underline !important; color: blue;">'+data[i]+'</a>';
					
						
						}else
						{
						links = links+', <a href="http://lowrysmartportal.com/index.php/welcome/assets/'+finalordernumber+'" style="text-decoration: underline !important; color: blue;">'+data[i]+'</a>';
