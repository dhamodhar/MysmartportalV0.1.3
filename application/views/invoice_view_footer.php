    ...
    $("#wait").css("display", "none");
	  ...
	  $.ajax({
			...
			var rel_number = $(this).find('rel_numb').text();
						...
						$("#order_details").html("<p class='text-uppercase text-strong mb-10 custom-font'>Invoice Number(s)</p><ul class='list-unstyled text-default lt mb-20'><li><strong>Order Number : </strong>"+order_numb+"</li><li><strong>Order Date : </strong> "+order_date+"</li><li><strong>Shipping Date : </strong> "+ship_date+"</li><li><strong>Post Date : </strong> "+post_date+"</li><li><strong>Tax Amount : </strong> $ "+total_tax+"</li><li><strong>Shipping Charges : </strong>$ "+shipping_charge+"</li><li><strong>Handling Charges : </strong>$ "+handling_charges+"</li><li><strong>Total Invoice : </strong> $ "+amount+"</li><li><strong>Carrier : </strong> "+carrier+"</li></ul>");
...
$("#order_number").html(invoice_numb);
						...
						displayorder_details(order_number_final);
       ...
       function displayorder_details(order_number_final)
{
var tt = order_number_final.trim()+"-001";
//alert(tt);
 $(document).ajaxStart(function(){
    $("#wait").css("display", "block");
     });
 ...
 $.ajax({
			...
			//$('#orders-list tbody').append(xml);
			   ...
			   $('#orders-list tbody').append("<tr><td>"+item_no+"</td><td>"+part_desc+"</td><td>"+part_code+"</td><td>"+qty+"</td><td >"+uom+"</td><td >"+item_price+"</td><td>"+extended_price+"</td><td>"+act_ship_date+"</td></tr>");
                 //datatables();           
		   });
