...
<li> <a href="<?php echo base_url()?>index.php/welcome/questionnaire" <?php if($this->uri->segment(2) == url_title('questionnaire', TRUE)){?> class="orders-active" <?php } ?>><i class="fa fa-caret-right"></i> Questionnaire</a></li>
                                         ...
                                         <li <?php if($this->uri->segment(2) == url_title('orders', TRUE) or $this->uri->segment(2) == url_title('open_orders', TRUE) or $this->uri->segment(2) == url_title('order_view', TRUE) or $this->uri->segment(2) == url_title('invoice_view', TRUE) or $this->uri->segment(2) == url_title('open_invoices', TRUE) or $this->uri->segment(2) == url_title('past_due_invoices', TRUE)){?> class="active open"<?php }?>>
                                                ...
                                                <ul <?php if($this->uri->segment(2) == url_title('open_orders', TRUE) or $this->uri->segment(2) == url_title('orders', TRUE) or $this->uri->segment(2) == url_title('open_invoices', TRUE) or $this->uri->segment(2) == url_title('order_view', TRUE) or $this->uri->segment(2) == url_title('past_due_invoices', TRUE))   {?> style="display:block"<?php }?>>
                                                   <!-- <li class="top-41"> <a href="<?php echo $url?>" <?php if($this->uri->segment(2) == url_title('orders', TRUE)){?> class="orders-active" <?php } ?>><i class="fa fa-caret-right"></i> Orders & Invoices</a></li>-->
													 <li class="top-41"><a href="<?php echo $url1; ?>" <?php if($this->uri->segment(2) == url_title('open_orders', TRUE) or $this->uri->segment(2) == url_title('order_view', TRUE)){?> class="orders-active" <?php } ?>><i class="fa fa-caret-right"></i>Open Orders</a></li>
                                                    <li><a href="<?php echo $url2; ?>" <?php if($this->uri->segment(2) == url_title('open_invoices', TRUE) or $this->uri->segment(2) == url_title('invoice_view', TRUE)){?> class="orders-active" <?php } ?>><i class="fa fa-caret-right"></i>Invoices</a></li>
										...
										<?php }else if($menu[$i]['id']==4)
										  {
										  if(in_array($menu[$i]['id'], $id) == 1){
										 $url =  base_url()."index.php/welcome/LoginAuthentication";
										...
										<?php } else if($menu[$i]['id']==6)
										 ...
										 $assets_under_service = base_url()."index.php/welcome/assetsendofserviceassets";
										 }else{
										 $url = base_url()."index.php/welcome/accessdenied";
		                                   $url1 = base_url()."index.php/welcome/accessdenied";
										   $url2 = base_url()."index.php/welcome/accessdenied";
										   ...
										   $assets_under_service = "#";
										 };
										?>
										     <li <?php if($this->uri->segment(2) == url_title('assets', TRUE) or $this->uri->segment(2) == url_title('assets_under_contracts', TRUE) or $this->uri->segment(2) == url_title('assets_no_contracts', TRUE) or $this->uri->segment(2) == url_title('assets_under_warranty', TRUE) or $this->uri->segment(2) == url_title('assetsendoflife', TRUE) or $this->uri->segment(2) == url_title('assetsendofserviceassets', TRUE)){?> class="active open"<?php }?>><a role="button" href="<?php echo $url?>" tabindex="0" class="asset  <?php if($this->uri->segment(2) == url_title('assets', TRUE)){?> asset-active <?php }?>"> <span>Asset Inventory</span></a>
                                         <ul <?php if($this->uri->segment(2) == url_title('assets_under_contracts', TRUE) or $this->uri->segment(2) == url_title('assets', TRUE) or $this->uri->segment(2) == url_title('assetsendoflife', TRUE) or $this->uri->segment(2) == url_title('assets_no_contracts', TRUE) or $this->uri->segment(2) == url_title('assets_under_warranty', TRUE) or $this->uri->segment(2) == url_title('assetsendofserviceassets', TRUE)){?> style="display:block;" <?php } ?>>
													 ...
													 <li> <a href="<?php echo $url2;?>" <?php if($this->uri->segment(2) == url_title('assetsendoflife', TRUE)){?> class="orders-active"  <?php } ?>><i class="fa fa-caret-right"></i> End of Product Life Cycle</a></li>
													 													 <li> <a href="<?php echo $assets_under_service;?>" <?php if($this->uri->segment(2) == url_title('assetsendofserviceassets', TRUE)){?> class="orders-active"  <?php } ?>><i class="fa fa-caret-right"></i> End of Service Life Cycle</a></li>
                                 ...
                                 -->
										<?php } else if($menu[$i]['id']==10)
										  {
										   if(in_array($menu[$i]['id'], $id) == 1){
										 $url = base_url()."index.php/welcome/mobility_social_media";
									  ...
									  <li <?php if($this->uri->segment(2) == url_title('mobility_social_media', TRUE)){?> class="active"<?php }?>><a href="<?php echo $url ?>" class="socialmedia <?php if($this->uri->segment(2) == url_title('mobility_social_media', TRUE)){?> active<?php }?>"> <span>Mobility Social Media</span></a></li>
