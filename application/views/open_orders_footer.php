    ...
    $("#wait").css("display", "none");
        ...
        $.ajax({
			...
			//$('#orders-list tbody').append(xml);
			   ...
			   $('#orders-list tbody').append("<tr><td style='widtd:180px;'><a href='<?php echo base_url()?>index.php/welcome/order_view/"+orderNumber+"'>"+orderNumber+"</a></td><td style='widtd:200px;'>"+order_date+"</td><td style='widtd:150px;'>"+po_number+"</td><td style='widtd:150px;'>"+tracker_no+"</td><td style='widtd:150px;'>"+order_date+"</td><td style='widtd:150px;'>$ "+invoice_amount+"</td><td style='widtd:150px;'>"+ship_city+" / "+ship_state+"</td></tr>");
                 //datatables();           
		   });
    ...
    $("#wait").css("display", "none");
        ...
        $.ajax({
			...
			$('#orders-list tbody').html("");
			   ...
			   $('#orders-list tbody').append("<tr><td style='widtd:180px;'><a href='<?php echo base_url()?>index.php/welcome/order_view/"+orderNumber+"'>"+orderNumber+"</a></td><td style='widtd:200px;'>"+order_date+"</td><td style='widtd:150px;'>"+po_number+"</td><td style='widtd:150px;'><a href='<?php echo base_url()?>index.php/welcome/order_view'>"+invoice_number+"</a></td><td style='widtd:150px;'>"+invoice_amount+"</td><td style='widtd:150px;'>"+ship_city+" / "+ship_state+"</td><td style='widtd:100px;'>"+order_status+"</td></tr>");
                 //datatables();           
		   });
