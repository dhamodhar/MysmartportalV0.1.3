...
echo "Good " . $dayTerm;?>&nbsp;:)</h2>
  ...
  <div class="row">
                        ...
                        <div class="margin-left-2 card-container col-lg-2 col-sm-6 col-sm-12">
                               ...
                               <a href="<?php echo base_url()?>index.php/welcome/open_orders"> <div class="front bg-greensea2">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo "4";?></p>
                        ...
                        <div class="card-container col-lg-2 col-sm-6 col-sm-12 ">
                                 ...
                                 <a href="#"> <div class="front bg-blue2">
...
<div class="card-container col-lg-2 col-sm-6 col-sm-12 ">
                                 ...
                                 <a href="#"> <div class="front bg-lightred2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-4">
                                         <i class="fa fa-file-text fa-4x"></i>
                                            <!--<img src="http://lowrysmartportal.com/assets/images/icons/contract-ic.png" style="padding-bottom:15px;"/>-->
                                        </div>
                                        <!-- /col -->
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo "11";?></p>
                                            <span>Renewal Contracts</span>
                                        </div>
                                        <!-- /col -->
                                    </div>
                                    <!-- /row -->
                        ...
                        <div class="card-container col-lg-2 col-sm-6 col-sm-12 ">
                               ...
                               <a href="#"> <div class="front bg-slategray2">
...
<div class="card-container col-lg-2 col-sm-6 col-sm-12 ">
                               ...
                               <a href="#"> <div class="front bg-blue2">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- col -->
                                        <div class="col-xs-8">
                                            <p class="text-elg text-strong mb-0"><?php echo "23";?></p>
...
<h1><b>At your service</b></h1>
<p style="margin-left:20px"><h4 align="center">Our in-house experts are standing by 24/7 to not only solve technical issues, but to give you the advice and guidance you need to succeed online.</h4></p>
</div>

<!--<img src="/assets/service-lookup-2.jpg" alt="Service Lookup" style="width:100%; height:100%;">-->

<div class="row" style="text-align: center; margin-top:30px;">
<button data-options="splash-2 splash-ef-16" data-target="#splash" data-toggle="modal" type="button" class="btn btn-primary btn-lg mb-10">Check Service Ticket</button>
<button onclick="newservice()" class="btn btn-warning btn-lg mb-10" type="button">New Service Request</button>
</div>


<div id="new_service_ticket" style="display:none;">
Device Serial Number* <input type="test" name="serial_number" id="serial_number"><input type="button" name="getdetails" id="getdetails" value="next" onclick="getallfields()">

</div>


<div id="full_info_ticket" style="display:none;">
<span>serial number</span><input type="text" name="sr_num" id="sr_num"> <br>
<span>serial number</span><input type="text" name="sr_num" id="sr_num"> <br>
<span>serial number</span><input type="text" name="sr_num" id="sr_num"> <br>
<span>serial number</span><input type="text" name="sr_num" id="sr_num"> <br>
<span>serial number</span><input type="text" name="sr_num" id="sr_num"> <br>
...
<div class="tile-body example">
 <div class="row">
 <div class="col-md-12">
<div class="row" id="ticket_info" style="display:none">
...
<!-- Splash Modal -->
 ...
 <div class="form-group col-md-12">
                                            ...
                                            <input type="email" placeholder="Enter Device Serial Number" name="ticket_number" id="ticket_number" class="form-control">
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button class="btn  btn-success" onclick="getstatus()">Search</button>
                        <button class="btn  btn-danger" name="cancel" id="cancel" data-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
